...
test('logintest', async() => {
    ...
    //  await page.waitForTimeout(5000);
     ...
     await employeeDetails.enterEmpDepartment();
     ...
     await employeeDetails.enterLocation();
     await employeeDetails.selectEmployeeReportingTo();
     await employeeDetails.selectEmployeeCertificates();
     await employeeDetails.clickOnAddButton();
})