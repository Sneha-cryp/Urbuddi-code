...
export default class LocatorsPage {
  ...
  constructor(public page: Page) { }
    ...
    readonly selectReportingTo = this.page.locator('//select[@id="reportingTo"]')
    readonly selectEmpCertificates = this.page.locator('//button[@class="dropdown-btn"]')
    readonly clickAddButton = this.page.locator('//button[text()="Add"]')
  ...
  async enterEmail() {
      ...
      async selectEmpRepotingTo(){
        await this.selectReportingTo.selectOption("bhanu@yopmail.com")
      }
      async selectCerticates(){
        await this.selectEmpCertificates.selectOption("10th, Degree, Original Degree")
      }
      async clickAdd(){
